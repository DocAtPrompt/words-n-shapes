...
(function (global) {
  ...
  var shuffleArray = function shuffleArray (arr) {
    for (var j, x, i = arr.length; i;) {
      j = Math.floor(randomFn() * i)   // PATCH (Wordcloud-Generator Phase 5)
      x = arr[--i]
      arr[i] = arr[j]
      arr[j] = x
    }
  ...
  // PATCH (Wordcloud-Generator Phase 5) — injizierbare Zufallsquelle für Seed-Reproduzierbarkeit.
  ...
  var WordCloud = function WordCloud (elements, options) {
    ...
    // PATCH (Wordcloud-Generator Phase 5) — Seed-Quelle aus Options übernehmen.
    ...
    var getRotateDeg = function getRotateDeg () {
      ...
      if (randomFn() > settings.rotateRatio) {   // PATCH (Wordcloud-Generator Phase 5)
        return 0
      }
      ...
      if (rotationSteps > 0) {
        ...
        return minRotation +
          Math.floor(randomFn() * rotationSteps) *   // PATCH (Wordcloud-Generator Phase 5)
          rotationRange / (rotationSteps - 1)
      } else {
        return minRotation + randomFn() * rotationRange   // PATCH (Wordcloud-Generator Phase 5)
      }
    }
